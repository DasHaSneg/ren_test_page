...
export const Main = () => {
    ...
    const handleChangeLanguage = (event: React.ChangeEvent<HTMLInputElement>) => {
        let l = (event.target as HTMLInputElement).value;
        setLocale(l);
        setLanguage(l);
    }
            ...
            <Container maxWidth="lg">
                    ...
                    >
                        <AppBar position="static" color="inherit">
                            <Toolbar>
                                ...
                                <Button variant="outlined" color="primary">{strings("connect_wallet")}</Button>
                            </Toolbar>
                        </AppBar>
                    </Paper>
                ...
                <main className="main">
                    <div className="content_wrapper">
                        <Paper
                            elevation={4}
                            sx={{maxWidth: 600, margin: "70px auto 0", transition: "margin 1s ease-out"}}
                        >
                            <MainTabs/>
                        </Paper>
                    </div>
